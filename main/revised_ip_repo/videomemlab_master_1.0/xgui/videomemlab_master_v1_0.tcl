...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_VIDEOMEM_BASE_ADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_PS2_SLAVE_BASE_ADDR" -parent ${Page_0}


}

proc update_PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR } {
	# Procedure called to update C_M_PS2_SLAVE_BASE_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR } {
	# Procedure called to validate C_M_PS2_SLAVE_BASE_ADDR
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR { MODELPARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR}] ${MODELPARAM_VALUE.C_M_PS2_SLAVE_BASE_ADDR}
}
