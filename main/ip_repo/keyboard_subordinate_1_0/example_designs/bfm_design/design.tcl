proc create_ipi_design { offsetfile design_name } {
	...
	set keyboard_subordinate_0 [ create_bd_cell -type ip -vlnv user.org:user:keyboard_subordinate:1.0 keyboard_subordinate_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:keyboard_subordinate:1.0]]]]
