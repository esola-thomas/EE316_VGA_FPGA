proc create_ipi_design { offsetfile design_name } {
	...
	set vga_bram_0 [ create_bd_cell -type ip -vlnv user.org:user:vga_bram:1.0 vga_bram_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:vga_bram:1.0]]]]
