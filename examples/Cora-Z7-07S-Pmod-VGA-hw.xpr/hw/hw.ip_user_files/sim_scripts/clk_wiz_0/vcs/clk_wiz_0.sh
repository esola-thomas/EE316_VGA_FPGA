...
#
# Generated by Vivado on Fri Apr 07 16:00:36 EDT 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../hw.gen/clk_wiz_0/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../hw.gen/clk_wiz_0/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/repos/EE316/EE316_VGA_FPGA/examples/Cora-Z7-07S-Pmod-VGA-hw.xpr/hw/hw.cache/compile_simlib/vcs"
  fi
